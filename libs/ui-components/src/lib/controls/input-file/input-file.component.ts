...
import { FileInput } from '@ocw/ui-core';


@Component({
  selector: 'ocw-input-file',
...
export class InputFileComponent implements MatFormFieldControl<FileInput>, ControlValueAccessor, OnInit, OnDestroy {
  ...
  get lastModifiedDate() {
    return this.value ? this.datePipe.transform(this.value.lastModified, 'short') : '';
  }
