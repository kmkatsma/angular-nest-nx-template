...
export class Auth0Service {
  ...
  constructor(private router: Router, private environmentService: Environment) {
    // Create an observable of Auth0 instance of client
    this.auth0Client$ = (from(
      createAuth0Client({
        domain: this.environmentService.authDomain,
        client_id: this.environmentService.clientId,
        redirect_uri: `${window.location.origin}`,
        audience: this.environmentService.authAudience,
      })
